...
def test_get_response(requests_mock):
    ...
    requests_mock.get(api_url, json = {'documents': [{'documentId': 'EPA-HQ-OAR-2011-0028-0041' }]}, status_code=200)
...
def test_status_code_2OO(requests_mock):
    ...
    requests_mock.get(api_url, json = {'documents': [{'documentId': 'EDA-MP-OAR-2017-2244-1199' }]}, status_code=200)
...
def test_bad_apikey(requests_mock):
    ...
    requests_mock.get(api_url, json = {'documents': [{'documentId': 'FOP-RM-SDF-2014-3344-9988' }]}, status_code=403)
